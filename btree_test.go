...
func TestBtree1(t *testing.T) {
	...
	*/
	...
	//聚簇索引，非叶子节点
	ShowBtree(path, 3, fields, priIndex, priIndex, tableCharset, inputCharset, rowFormat)
	...
	//
	////二级索引，非叶子节点
	//ShowBtree(path, 4, fields, secIndex1, priIndex, tableCharset, inputCharset, rowFormat)
}